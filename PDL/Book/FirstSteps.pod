...
Many of the graphics examples in this chapter use a simplified
interface to whatever PDL Graphics library you have installed.
However, this simplified interface is not included with the normal PDL
distribution.  To get it, install PDL::Graphics::Simple from CPAN.
This should do it (perhaps prefixed with 'sudo'):

  myhost% cpan PDL::Graphics::Simple

For interactive use PDL comes with a program called C<perldl>. This is a REPL which allows
...
which is another PDL shell with additional features, available on CPAN
as L<PDL::Perldl2>.
...
=for html <p> <img width="400" alt="" src="firststeps/sepia/crop/whirl-sync.png"/></p>
...
=for comment
move sourceforge to github/ PDL-SampleData/files and copy across flatfield fixed_gal and fake_star
...
I<ndarrays> (short for 'n-dimensional array') to distinguish them from ordinary Perl
'arrays'.  We'll say more about this later.
...
convenient. If you are calling more than one function however, it is better to
...
=for html <p> <img width="600" alt="" src="firststeps/sepia/crop/whirl-m51-default.png"/></p>



Figure of the raw image C<m51_raw.fits> shown with progressively
greater contrast using the C<imag> command.
...
=for html <p> <img width="600" alt="" src="firststeps/sepia/crop/whirl-m51-1000.png"/></p>
...
=for html <p> <img width="600" alt="" src="firststeps/sepia/crop/whirl-m51-300.png"/></p>
...
=for html <p> <img width="400" alt="" src="firststeps/sepia/crop/whirl-flat.png"/></p>
...
262144 data values in the ndarrays C<$a>  and C<$flat>.> And it was
...
C code, which is what makes PDL very efficient for processing
large chunks of data. If you did the same operation using normal
perl arrays rather than ndarrays it would be about ten to twenty times slower
(and use ten times more memory). In fact we can
do whatever arithmetic operations we like on image ndarrays:

=for html <p> <img width="400" alt="" src="firststeps/sepia/crop/whirl-flattened.png"/></p>
...
Or on 1-D line ndarrays. On on 3-D cubic ndarrays. In fact ndarrays can support an infinite
number of dimensions (though your computer's memory won't). 
...
as a shorthand for C<print> - which only works in the C<pdl> shell)
...
=for html <p> <img width="400" alt="" src="firststeps/sepia/crop/whirl-maska.png"/></p>



=for html <p> <img width="400" alt="" src="firststeps/sepia/crop/whirl-maskb.png"/></p>



=for html <p> <img width="400" alt="" src="firststeps/sepia/crop/whirl-maskc.png"/></p>



=for html <p> <img width="400" alt="" src="firststeps/sepia/crop/whirl-maskd.png"/></p>
...
=for html <p> <img width="400" alt="" src="firststeps/sepia/crop/whirl-star-radial.png"/></p>
...
about what we don't know use C<apropos>:
  ...
  fitgauss1d      Fit 1D Gaussian to data ndarray
  fitgauss1dr     Fit 1D Gaussian to radial data ndarray
...
generates a new ndarray with N values ranging 0..(N-1).
...
=for html <p> <img width="300" alt="" src="firststeps/sepia/crop/whirl-starsima.png"/></p>



=for html <p> <img width="300" alt="" src="firststeps/grey/work/whirl-starsimb.png"/></p>
...
=for comment should we not be using my declarations in example code?
...
=for html <p> <img width="400" alt="" src="firststeps/sepia/crop/whirl-fakestars.png"/></p>
...
are represented in PDL by separate real and imaginary arrays; see PDL::Complex.)
...
=for html <p> <img width="400" alt="" src="firststeps/sepia/crop/gal-filter.png"/></p>
...
=for html <p> <img width="400" alt="" src="firststeps/sepia/crop/whirl-ffta.png"/></p>



=for html <p> <img width="400" alt="" src="firststeps/sepia/crop/whirl-fftb.png"/></p>
