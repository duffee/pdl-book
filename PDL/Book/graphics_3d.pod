...
=for html <p> <img width="300" alt="" src="graphics_3d/gnuplot-eg.png"/></p>
...
=for html <p> <img width="200" alt="" src="graphics_3d/pdltrid-eg1.png"/></p>



=for html <p> <img width="200" alt="" src="graphics_3d/pdltrid-eg2.png"/></p>
...
creates a one-dimensional ndarray with 30 elements that has linear 
values from 0 to 7:
...
useful for exactly this purpose: creating ndarrays of equally 
...
explanation).  This results in a 2-dimensional ndarray with the 
...
if C<$ndarray> is intended to be the Z axis values of a rectangular 
...
C<$ndarray> has exactly three elements. As you probably have already guessed, 
these three elements are X, Y and Z. So what you can do is pass 
C<$ndarray> with shape C<[3,t,u]> which is the same as a 
2-dimensional C<[t,u]> lattice with a 3-vector at each point. This 
ndarray will then be interpreted parametrically: the mesh will be 
...
coming from somewhere. First, set up the ndarrays and the 
parameter variables:
...
=for html <p> <img width="300" alt="" src="graphics_3d/color-torus.png"/></p>
...
the RGB ndarrays to form a single C<[3,60,20]> ndarray that could be
...
once, if we pack all the surfaces into an ndarray of shape C<[3,n_t,n_u,...]>
...
=for html <p> <img width="300" alt="" src="graphics_3d/torus-stack.png"/></p>
...
=for html <p> <img width="300" alt="" src="graphics_3d/torus-stack-warp.png"/></p>
...
=for html <p> <img width="300" alt="" src="graphics_3d/two-prob-distributions.png"/></p>
...
=for html <p> <img width="300" alt="" src="graphics_3d/busy-lorenz-attr.png"/></p>
...
=for html <p> <img width="300" alt="" src="graphics_3d/timeseries-lorenz.png"/></p>
...
=for html <p> <img width="300" alt="" src="graphics_3d/timeseries-lorenz-thick.png"/></p>
...
the origin. The ndarray C<$a> is two-dimensional so just like for 
...
where the RGB ndarrays are two-dimensional and C<$colors> has three 
...
=for html <p> <img width="400" alt="" src="graphics_3d/fractal-mountain-sequence.png"/></p>
...
use the same ndarray for the three coordinates (with a simple 
...
=for html <p> <img width="400" alt="" src="graphics_3d/nest-sphere-01.png"/></p>
...
first round, the ndarray contains values 0,1,2,3 after the second 
...
So after the loop, we have a three-dimensional ndarray with one 
index less in each dimension, and each value in that ndarray 
...
=for html <p> <img width="400" alt="" src="graphics_3d/nest-sphere-02.png"/></p>
...
=for html <p> <img width="400" alt="" src="graphics_3d/nest-sphere-moire.png"/></p>
