...
Many of the examples, discussed below, are from the F<t> directory of the
L<PDL::Graphics::PLplot source|https://github.com/PDLPorters/pdl-graphics-plplot>.
These are written in the functional style, and are direct translations of the
examples which come with the B<PLplot C library> 

The rest of the examples are object-oriented, derived from David
...
=for html <p><a href="PLplot/work/w03.pl"> w03.pl text source code</a></p><hr/>
...
=head2 Setting the DEV and FILE options, and using the aliased option for new()
  ...
  For output to a memory buffer:
         ...
         -- option MEM must be passed an ndarray where the results will be plotted
...
option. You specify error bars in x and y by passing a scalar or an
ndarray with those errors to XERRORBAR and YERRORBAR.
...
=for html <p><a href="PLplot/work/w04.pl"> w04.pl text source code</a></p><hr/>
...
Depending on what you want, there are at least five ways to plot multiple curves.
    ...
    -- plot a multidimensional ndarray
...
=head3 Plotting multiple curves with a multi-dimensional ndarray
...
=for html <p><a href="PLplot/work/w05.pl"> w05.pl text source code</a></p><hr/>
...
Use color to differentiate different data sets:
   ...
   -- For multidimensional ndarrays, plot as POINTS and use the
...
=for html <p><a href="PLplot/work/w06.pl"> w06.pl text source code</a></p><hr/>



=head3 Plotting multiple curves with differently colored calls to C<xyplot>

An alternative to plotting a multi-dimensional ndarray, you can plot multiple
...
=for html <p><a href="PLplot/work/w07.pl"> w07.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w09.pl"> w09.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w10.pl"> w10.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w11.pl"> w11.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w12.pl"> w12.pl text source code</a></p><hr/>
...
These are measured either in pixels or millimeters depending on
...
=for html <p><a href="PLplot/work/w13.pl"> w13.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w14.pl"> w14.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w15.pl"> w15.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w16.pl"> w16.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w17.pl"> w17.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w18.pl"> w18.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w19.pl"> w19.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w20.pl"> w20.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w21.pl"> w21.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w22.pl"> w22.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w23.pl"> w23.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w24.pl"> w24.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w25.pl"> w25.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w26.pl"> w26.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w27.pl"> w27.pl text source code</a></p><hr/>
...
=item --  load an image and plot over that image

=item --  plot to a custom windowing device
...
=for html <p><a href="PLplot/work/w29.pl"> w29.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x01.pl"> x01.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x02.pl"> x02.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x03.pl"> x03.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x04.pl"> x04.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x05.pl"> x05.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x06.pl"> x06.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x07.pl"> x07.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x08.pl"> x08.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x09.pl"> x09.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x10.pl"> x10.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x11.pl"> x11.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x12.pl"> x12.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x13.pl"> x13.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x15.pl"> x15.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x16.pl"> x16.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x17.pl"> x17.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x18.pl"> x18.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x19.pl"> x19.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x21.pl"> x21.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x22.pl"> x22.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x23.pl"> x23.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x24.pl"> x24.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x25.pl"> x25.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x26.pl"> x26.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x27.pl"> x27.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x28.pl"> x28.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x29.pl"> x29.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x30.pl"> x30.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/x33.pl"> x33.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w30.pl"> w30.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w31.pl"> w31.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w32.pl"> w32.pl text source code</a></p><hr/>
...
=for html <p><a href="PLplot/work/w33.pl"> w33.pl text source code</a></p><hr/>
