...
include Perl, TCL, JavaScript, Visual Basic, Python, and many more.
Such systems have also been developed for data processing. Worthy of
note are commercial software such as C<IDL> ('Interactive Data Language' from
Exelis L<http://www.exelisvis.com>), C<MATLAB> (from The
...
the above requirements. Indeed there is already a numerical extension
